...
void otau_init(void)
{
	...
	char *pnt = str + 11; // указатель на число каналов в ответе otau
	
	// ответ otau
	// <HC-MEMS-1ЎБ4-S-162-M3-9-90-10-FA_VER3.11_SN20240507009_ 01.08.0488>  12 место число портов, версии 6.1 6.2
	// <HC-MEMS-1ЎБ28-S-162-M3-9-90-10-FA_VER3.11_SN20240507001_ 01.08.2416>
	//            12,13 count channels
	
	//<HC-MEMS-1X28-S-162-M3-9-90-10-SA_VER3.11_SN20241210033_ 01.08.2424>    11 место число портов, версия  6.3
	//<HC-MEMS-1X16-S-162-M3-9-90-10-SA_VER3.11_SN20241210007_ 01.08.1654>
