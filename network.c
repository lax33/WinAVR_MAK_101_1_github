...
//							printf("--- CMD_INI_RD, cnt = %d\r\n", tmp);
				...
				{
					is_cmd_inisize = 1; // означает что команда ini_size была принята и тогда размер ини файла принемается за 767 при выполнении вычитки ini (CMD_INI_RD), в противном случае 480 (для старого ПО)
