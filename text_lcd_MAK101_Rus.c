...
const unsigned char font[][8] = {
	...
	{0x15, 0x15, 0x15, 0x15, 0x15, 0x15, 0x1F, 0x00},	// Ш	- 0x01
	...
	{0x1F, 0x11, 0x10, 0x1E, 0x11, 0x11, 0x1D, 0x00}};	// Б	- 0x07

const unsigned char font2[][8] = {
	{0x11, 0x11, 0x11, 0x0F, 0x01, 0x01, 0x01, 0x00},	// Ч	- 0x00  +
...
//6  ВЫКЛ. МАК 100 ЖДИТЕ
	{' ', 'B', 0x05, 'K', 0x07, '.',  ' ', 'M', 'A', 'K', ' ', '1', '0', '0', ' ', ' '},	// font2
	{' ', ' ', ' ', ' ', 0x01, 0x06, 0x03, 'T', 'E', '.', '.', '.', ' ', ' ', ' ', ' '},
	
//7 ПИТАНИЕ МОЖНО ОТКЛЮЧИТЬ  0X07
	{' ', ' ', ' ', ' ',0x04,0x03, 'T', 'A', 'H',0x03, 'E', ' ', ' ', ' ', ' ', ' '},		// font2
	{'M', 'O',0x01, 'H', 'O', ' ', 'O', 'T', 'K',0x07,0x02,0x00,0x03, 'T', 'b', ' '},
	
//8	 ПОДКЛЮЧЕНИЕ К  OTDR                          
	{'M', 'A', 'K', ' ', '1', '0', '0', ' ', ' ', ' ', ' ', '0', '0', 'x', 'x', 'x'},		// font2
	{0x04,'O',0x06, 'K',0x07,0x02,0x00, '.', ' ', 'K', ' ', 'O', 'T', 'D', 'R', ' '},
	
//9			             О   Ш    И    Б     К    А    :     x    х    х	
	{' ', ' ', ' ','O',0x01,0x03,0x07, 'K', 'A', ' ', ':', ' ', ' ', 'x', 'x', 'x'}, 	
    {' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' '},
