...
const unsigned char font[][8] = {
	{0x1F, 0x11, 0x10, 0x10, 0x10, 0x10, 0x10, 0x00},	// Г	- 0x00
	{0x15, 0x15, 0x15, 0x0E, 0x15, 0x15, 0x15, 0x00},	// Ж	- 0x01
	{0x0F, 0x05, 0x05, 0x09, 0x11, 0x1F, 0x11, 0x11},	// Д	- 0x02
	{0x11, 0x11, 0x13, 0x15, 0x19, 0x11, 0x11, 0x00},	// И	- 0x03
	{0x1F, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x00},	// П	- 0x04
	{0x11, 0x11, 0x11, 0x0A, 0x04, 0x08, 0x10, 0x00},	// У	- 0x05
	{0x0F, 0x11, 0x11, 0x0F, 0x05, 0x09, 0x11, 0x00},	// Я	- 0x06
	{0x1F, 0x11, 0x10, 0x1E, 0x11, 0x11, 0x1E, 0x00}};	// Б	- 0x07

const unsigned char font2[][8] = {
	{0x1F, 0x11, 0x10, 0x1E, 0x11, 0x11, 0x1E, 0x00},	// Б	- 0x00
	{0x15, 0x15, 0x15, 0x0E, 0x15, 0x15, 0x15, 0x00},	// Ж	- 0x01
	{0x12, 0x15, 0x15, 0x1D, 0x15, 0x15, 0x12, 0x00},	// Ю	- 0x02
	{0x11, 0x11, 0x13, 0x15, 0x19, 0x11, 0x11, 0x00},	// И	- 0x03
	{0x11, 0x11, 0x11, 0x0A, 0x04, 0x08, 0x10, 0x00},	// У	- 0x04
	{0x11, 0x11, 0x11, 0x19, 0x15, 0x15, 0x19, 0x00},	// Ы	- 0x05
	{0x0F, 0x05, 0x05, 0x09, 0x11, 0x1F, 0x11, 0x11},	// Д	- 0x06
	{0x0F, 0x05, 0x05, 0x05, 0x05, 0x15, 0x09, 0x00}};	// Л	- 0x07

const unsigned char font3[][8] = {
	{0x11, 0x11, 0x11, 0x0A, 0x04, 0x08, 0x10, 0x00},	// У	- 0x00	+
	{0x15, 0x15, 0x15, 0x0E, 0x15, 0x15, 0x15, 0x00},	// Ж	- 0x01	+
	{0x1F, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x00},	// П	- 0x02	+
	{0x11, 0x11, 0x13, 0x15, 0x19, 0x11, 0x11, 0x00},	// И	- 0x03	+
	{0x1F, 0x11, 0x10, 0x1E, 0x11, 0x11, 0x1E, 0x00},	// Б	- 0x04	+
	{0x11, 0x11, 0x11, 0x0F, 0x01, 0x01, 0x01, 0x00},	// Ч	- 0x05	+
	{0x12, 0x15, 0x15, 0x1D, 0x15, 0x15, 0x12, 0x00},	// Ю	- 0x06	+
	{0x0F, 0x05, 0x05, 0x05, 0x05, 0x15, 0x09, 0x00}};	// Л	- 0x07	+

u_char current_font = 0x00;

const unsigned char displays[][16] = {
	{0x07, 0x05,  'C', '-',  '1', '5',  ' ', ' ',  ' ', ' ', ' ', '0', '0', 'x', 'x', 'x'},
	{ ' ',  ' ',  ' ', ' ',  '3', 'A', 0x00, 'P', 0x05, '3', 'K', 'A', ' ', ' ', ' ', ' '},

	{0x07, 0x05,  'C', '-',  '1', '5', ' ', ' ', ' ', ' ', ' ', '0', '0', 'x', 'x', 'x'},
	{0x00, 'O', 'T', 'O', 'B', ' ', ' ', ' ', ' ', 0x04, 'O', 'P', 'T', ' ', '0', 'x'},

	{' ', ' ', ' ', 0x03, '3', 'M', 'E', 'P', 'E', 'H', 0x03, 'E', ' ', ' ', ' ', ' '},
	{' ', ' ', ' ', 0x04, 'O', 'P', 'T', ' ', '-', ' ',  '0', 'x', ' ', ' ', ' ', ' '},

	{'A', 'B', 'A', 'P', 0x03, 0x06, '?', ' ', 0x04, 'O', 'P', 'T', '-', '0', 'x', ' '},
	{' ', ' ', ' ', ' ', ' ',  ' ',  ' ', 'x',  '.', 'x', '0', '0', '0', ' ', 'K', 'M'},
	...
	{' ', 'B', 0x05, 'K', 0x07, '.',  ' ', ' ', 0x00, 0x04, 'C', '-', '1', '2', ' ', ' '},	// font2
	{' ', ' ', ' ', ' ', 0x01, 0x06, 0x03, 'T',  'E',  '.', '.', '.', ' ', ' ', ' ', ' '},

	{' ', ' ', 0x02, 0x03, 'T', 'A', 'H', 0x03, 'E',  ' ', 0x04, 0x00,  'C', ' ', ' ', ' '},	// font3
	{'M', 'O', 0x01,  'H', 'O', ' ', 'O',  'T', 'K', 0x07, 0x06, 0x05, 0x03, 'T', 'b', ' '},
...
void display_init(void)
{
	...
	// I/D = 1 (курсор сдвигается вправо)
	// S = 0 (нет сдвига дисплея)
...
void display_set_font3(void)
{
	u_char i, *pf = (u_char *)font3;

	if (current_font == 0x03)
		return;
...
{
	display_show(1, 0x00, port, 0x00, get_rtu_number());
}
...
void display_show(u_char index, u_int port, u_int d_len, u_int f_len, u_long num)
{
	...
	if ((index == 0x01) && (otau_get_count_channels() == 1))
		index = 0x08;
	...
	switch (index)
	{
		...
		case 0x04 :
			...
			display_show_string(16 - strlen((char *)buff), 0, buff);
			utoa(d_len, (char *)buff, 10);
			display_show_string(15 - strlen((char *)buff), 1, buff);
			break;
		case 0x05 :
			sprintf((char *)buff, "%07lu", num);
			display_show_string(16 - strlen((char *)buff), 0, buff);
...
void display_write_byte(u_char byte, u_char byte_type)
{
	...
	/// display_wait_for_work();	// ожидание готовности дисплея
    _delay_loop_2(147);		// 147 * 4 cycles = 40mks
}
...
void display_wait_for_work(void)
{
	...
	display_can_read();			// разрешаем чтение дисплея
	cbi(LCD_OUT, LCD_RS);		// выбор IR
	...
	while (1)
	{
		sbi(LCD_OUT, LCD_E);	// читаем первую тетраду в аккумулятор
		_delay_loop_2(1);		// и заносим бит занятости дисплея BF в T
		bt = LCD_IN;
		cbi(LCD_OUT, LCD_E);

		_delay_loop_2(1);

		sbi(LCD_OUT, LCD_E);	// читаем вторую тетраду, хотя она нам и не нужна
		_delay_loop_2(1);
		cbi(LCD_OUT, LCD_E);
