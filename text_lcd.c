...
u_char current_font = 0x01;

const unsigned char displays[][16] = {
	{'M', 'A', 'K', ' ',  '1', '0',  '0', ' ', ' ', ' ', ' ', '0', '0', 'x', 'x', 'x'},
	{'3', 'A', 0x00, 'P', 0x05, '3', 'K', 'A', ' ', ' ', ' ', '0', '0', ':', '0', '0'},
...
void display_show(u_char index, u_int port, u_int d_len, u_int f_len)
{
	u_char *pstr = (u_char *)displays, i, buff[7];
